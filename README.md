...
| **Launcher de Apps** | [Wofi](https://hg.sr.ht/~scoopta/wofi) | Janela central translúcida, ícones e destaque em laranja. |
...
```text
~/dotfiles/
├── gtk/          # Configurações GTK-2.0 e GTK-3.0 (settings.ini, dark mode)
...
├── wofi/         # Configurações e estilos do inicializador de aplicativos
